...
home-layout.ts: 首页响应式布局规则，计算品牌字形尺寸、header 占位宽度与随机按钮断点。
home-visual.test.ts: 视觉规则回归测试，约束 header 宽度、随机按钮断点与弱化文字对比度。
...
变更日志
2026-06-01: 新增 home-layout.ts 与 home-visual.test.ts，修复首页响应式与配色规则。
